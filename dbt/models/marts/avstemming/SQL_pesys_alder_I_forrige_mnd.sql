...
vedtak as (
   select vedtak_id,
    ...
    where k_sak_t = 'ALDER'  
      ...
      and dato_lopende_fom <= to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')
      and (dato_lopende_tom is null or dato_lopende_tom >= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')))
),
...
(select v.vedtak_id,
   ...
   from vedtak v
        inner join pen.t_beregning_res br on br.vedtak_id = v.vedtak_id
                                         and br.dato_virk_fom <= to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')
                                         and (br.dato_virk_tom is null or br.dato_virk_tom >= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')))
...
(select v.vedtak_id,
   ...
   from vedtak v
        inner join pen.t_beregning b 
               ...
               and b.dato_virk_fom <= to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')
               and (b.dato_virk_tom is null or b.dato_virk_tom >= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss'))) 
...
(select v.sak_id, 
   ...
   from yk_bres v
        ...
        inner join pen.t_uttaksgrad ug on ug.kravhode_id = v.kravhode_id 
                                      and ug.dato_virk_fom <= to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')
                                      and (ug.dato_virk_tom is null or ug.dato_virk_tom >= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')))
--                                      and ug.uttaksgrad <> 0
        inner join pen.t_beregning_res br on br.vedtak_id = v.vedtak_id
                                         and br.dato_virk_fom <= to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')
                                         and (br.dato_virk_tom is null or br.dato_virk_tom >= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')))
...
(select x.vedtak_id, 
   ...
   from (select aktive.vedtak_id, 
          ...
          where tvv.dato_virk_fom <= to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')
            and (tvv.dato_virk_tom >= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')) or tvv.dato_virk_tom is null)
         ) x
   where x.rn = 1
)
...
------------------------------------------------------------------------------
SELECT to_number(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)),'YYYYMM')) as periode,
       ...
       case
          when exists (select null
                        ...
                        where v2.person_id = aktive.person_id
                          and v2.dato_lopende_fom <= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss'))
                          and (v2.dato_lopende_tom is null or v2.dato_lopende_tom >= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')))
                          and v2.k_sak_t = 'AFP_PRIVAT'
                          and not exists (select null
                                            from pen.t_UTTAKSGRAD u2 
                                           where u2.sak_id = v2.sak_id 
                                             and u2.dato_virk_fom <= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')) 
                                             and (u2.DATO_VIRK_TOM is null or u2.DATO_VIRK_TOM >= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss'))) 
                                             and u2.uttaksgrad = 0)
                       ) then 1
          else 0
       ...
       case
          when exists (select null
                        ...
                        WHERE pvv.vedtak_id = aktive.vedtak_id
                          ...
                          AND PVV.dato_virk_fom < to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')
                          AND (PVV.dato_virk_tom >= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')) 
       ...
       case
           when exists (select null
                         ...
                         WHERE aktive.person_id = p.person_id
                           ...
                           AND MONTHS_BETWEEN(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), p.dato_fodsel) BETWEEN (62*12+1) AND (67*12+1)
                           AND a.virk_fom <= to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')
                           and (a.virk_tom >= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')) or a.virk_tom is null)
                        ) then 1
                 else 0
...
--               and bi_avdod.dato_virk_fom <= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss'))
--               and (bi_avdod.dato_virk_tom is null or bi_avdod.dato_virk_tom >= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')))
