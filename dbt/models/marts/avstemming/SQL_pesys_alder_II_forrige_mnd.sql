--create or replace view vw_pesys_alder_ii_forrige_mnd as
-------------------------------------------------------------------------------
-- Eirik Grønli
-- 28. aug 2025
--
   ...
   select v.vedtak_id, 
     ...
     from pen.t_vedtak  v
          ...
          inner join pen.t_beholdning bh 
                 ...
                 and bh.dato_fom <= to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')
                 and (bh.dato_tom is null or bh.dato_tom >= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss'))) 
    where bh.beholdning_id is not null
      ...
      and v.dato_lopende_fom <= to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')
      and (v.dato_lopende_tom is null or v.dato_lopende_tom >= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')))
      ...
      from (select distinct person_id, kravhode_id, k_inntekt_t,
            ...
            from (select pg.person_id, 
                   ...
                   where pg.person_id is not null
                     ...
                     and v.dato_lopende_fom <= to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')
                     and (v.dato_lopende_tom is null or v.dato_lopende_tom >= trunc(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')))
                     and to_char(i.dato_fom, 'YYYYMM') <= to_char(to_date(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')), 'YYYYMM') 
                     and (i.dato_tom is null 
                           or to_char(i.dato_tom, 'YYYYMM') >= to_char(to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMM'))
                 )
           ) inntekter
            ...
            from (select pg.person_id, 
                    ...
                    from pen.t_vedtak v
                         ...
                         inner join pen.t_person_det pd
                               ...
                               and pd.dato_fom <= to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss')
                               and (pd.dato_tom is null or pd.dato_tom >= to_date(to_char(to_timestamp(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)), 'YYYYMMDD') || ' 23:59:59', 'YYYYMMDD HH24:mi:ss'), 'YYYYMMDD hh24:mi:ss'), 'YYYYMMDD hh24:mi:ss'))
                               and pd.bruk = 1
                         inner join pen.t_inntekt i
                              on pg.person_grunnlag_id = i.person_grunnlag_id
                   where pg.person_id  is not null
...
------------------------------------------------------------------------------
SELECT --distinct
       to_number(to_char(LAST_DAY(ADD_MONTHS(current_date,-1)),'YYYYMM')) as periode,
...
--       person.fnr_fk as persnr,
       ...
       round(aktive.BEHOLDNING_PENSJON_BELOP,5) as BEHOLDNING_PENSJON_BELOP,
       round(aktive.BEHOLDNING_GARAN_PEN_BELOP,5) as BEHOLDNING_GARAN_PEN_BELOP,
       round(aktive.BEHOLDNING_GARAN_TLG_BELOP,5) as BEHOLDNING_GARAN_TLG_BELOP,
